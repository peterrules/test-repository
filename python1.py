...
# print("My", "name", "is", sep="_", end="*")# # Line 19 is a string and Line 20 is an integer 
# print("2")
# print(2)
...
# print(True < False)
# print(1==1)
# # input("Enter a number")# print(0.0000000000000000000001)# # #Write a one-line piece of code, using the print() function, as well as the newline and escape characters, to match the expected result outputted on three lines.
# print("I'm\n" "Learning\n" "Python")# # Using python as a calculator
# print(2+2)
# # when both ** arguments are integers, the result is an integer, too;
# # when at least one ** argument is a float, the result is a float, too.
# print(2 ** 2)
# print(2 ** 2.)
# # An * (asterisk) sign is a multiplication operator.# # # A / (slash) sign is a division operator.
# # # A division sign always lead to a float if needed or not
# print(6 / 3)# # # A double // removes float and always rounds
# print(4 / 3)
# print(4 // 3)
...
# miles = 7.38515# miles_to_kilometers = (miles * 1.61)
# kilometers_to_miles = (kilometers / 1.61)
# # print(miles + kilometers)# print(miles, "miles is", round(miles_to_kilometers, 4), "kilometers")
# print(kilometers, "kilometers is", round(kilometers_to_miles, 3), "miles")# #input allows the computer to read the user input
...
# str(7)# # # a double == compares to things together in python
# print(2 == 2)
# print(1 == 2)
...
# else:
#     print("lets stay inside")# income = float(input("Enter the annual income: "))
# # Using the round function in an if or else stament to round total
# if income < 85528:
#   tax = income * 0.18 - 556.02
# else:
#   tax = (income - 85528) * 0.32 + 14839.02# if tax < 0.0:
#   tax = 0.0
